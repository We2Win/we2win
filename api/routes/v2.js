...
router.get('/contents/ranking/:list/:date', ContentController.getRankingList);
...
router.get('/mng/contents/:cType/:amount/:id', ContentController.getContentsByFiltering);
